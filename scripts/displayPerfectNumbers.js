...
var affichage = function() {
    ...
    var nombre = document.getElementById("user-input2").value;
    ...
    document.getElementById("demande2").innerHTML += "Nombre saisi: " + nombre + '<br>';
    ...
    for (let i = 1; i <= (nombre - 1); i += 1) {
        if (nombre % i === 0) { // si i est un diviseur
            ...
            document.getElementById("demande2").innerHTML += "Somme des diviseurs: " + somme_des_diviseurs + '<br>';
        } else {
            // Ne rien faire
        }
    }
    ...
    if (somme_des_diviseurs == nombre) {
        document.getElementById("demande2").innerHTML += nombre + " est un nombre parfait." + "<br>";
    } else {
        document.getElementById("demande2").innerHTML += nombre + " n'est pas un nombre parfait." + "<br>";
    }
